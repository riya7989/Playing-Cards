...
/**
 * Tests that verify whether the BlackJack State works as expected.
...
public class BlackJackStateTest {
	...
	public void testConstructor() {
		GameState oneState = BlackJackState.getInstance();
		GameState twoState = BlackJackState.getInstance();
