...
/**
 * Tests that verify whether the PairHand6 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHand6Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHand6.getInstance();
		GameState twoState = PairHand6.getInstance();
