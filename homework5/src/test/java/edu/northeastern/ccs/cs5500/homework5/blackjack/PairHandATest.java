...
/**
 * Tests that verify whether the PairHandA State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHandATest {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHandA.getInstance();
		GameState twoState = PairHandA.getInstance();
