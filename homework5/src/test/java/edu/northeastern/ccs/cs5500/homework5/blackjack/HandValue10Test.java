...
/**
 * Tests that verify whether the HandValue10 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue10Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue10.getInstance();
		GameState twoState = HandValue10.getInstance();
