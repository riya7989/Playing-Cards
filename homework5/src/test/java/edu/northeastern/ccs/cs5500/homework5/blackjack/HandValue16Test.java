...
/**
 * Tests that verify whether the HandValue16 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue16Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue16.getInstance();
		GameState twoState = HandValue16.getInstance();
