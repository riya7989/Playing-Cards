...
/**
 * Tests that verify whether the HandValue12 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue12Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue12.getInstance();
		GameState twoState = HandValue12.getInstance();
