...
/**
 * Tests that verify whether the HandValue5to8 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue5to8Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue5to8.getInstance();
		GameState twoState = HandValue5to8.getInstance();
