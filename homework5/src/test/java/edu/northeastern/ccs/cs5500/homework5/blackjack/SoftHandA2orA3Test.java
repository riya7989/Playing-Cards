...
/**
 * Tests that verify whether the SoftHandA2orA3 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class SoftHandA2orA3Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = SoftHandA2orA3.getInstance();
		GameState twoState = SoftHandA2orA3.getInstance();
