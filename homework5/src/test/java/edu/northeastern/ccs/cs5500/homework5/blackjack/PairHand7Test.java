...
/**
 * Tests that verify whether the PairHand7 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHand7Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHand7.getInstance();
		GameState twoState = PairHand7.getInstance();
