...
/**
 * Tests that verify whether the SoftHandA8 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class SoftHandA8Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = SoftHandA8.getInstance();
		GameState twoState = SoftHandA8.getInstance();
