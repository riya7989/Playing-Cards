...
/**
 * Tests that verify whether the SoftHandA6 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class SoftHandA6Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = SoftHandA6.getInstance();
		GameState twoState = SoftHandA6.getInstance();
