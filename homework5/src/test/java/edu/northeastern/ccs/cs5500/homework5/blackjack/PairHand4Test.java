...
/**
 * Tests that verify whether the PairHand4 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHand4Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHand4.getInstance();
		GameState twoState = PairHand4.getInstance();
