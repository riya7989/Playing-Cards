...
/**
 * Tests that verify whether the HandValue11 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue11Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue11.getInstance();
		GameState twoState = HandValue11.getInstance();
