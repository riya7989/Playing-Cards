...
/**
 * Tests that verify whether the PairHand2or3 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHand2or3Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHand2or3.getInstance();
		GameState twoState = PairHand2or3.getInstance();
	...
	public void testFaceUpCardTwo() {
		...
		assertEquals("Game method called incorrect number of times", 1, mockGame.getSplitCounter());
