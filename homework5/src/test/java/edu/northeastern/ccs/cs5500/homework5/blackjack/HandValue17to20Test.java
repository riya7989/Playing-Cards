...
/**
 * Tests that verify whether the HandValue17to20 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue17to20Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue17to20.getInstance();
		GameState twoState = HandValue17to20.getInstance();
