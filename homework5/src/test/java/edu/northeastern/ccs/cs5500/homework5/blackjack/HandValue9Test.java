...
/**
 * Tests that verify whether the HandValue9 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class HandValue9Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = HandValue9.getInstance();
		GameState twoState = HandValue9.getInstance();
