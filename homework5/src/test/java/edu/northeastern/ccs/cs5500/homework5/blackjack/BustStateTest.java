...
/**
 * Tests that verify whether the Bust State works as expected.
...
public class BustStateTest {
	...
	public void testConstructor() {
		GameState oneState = BustState.getInstance();
		GameState twoState = BustState.getInstance();
	...
	public void testFaceUpCardTwo() {
		...
		assertEquals("Game method called incorrect number of times", 1, mockGame.getBustCounter());
	}
