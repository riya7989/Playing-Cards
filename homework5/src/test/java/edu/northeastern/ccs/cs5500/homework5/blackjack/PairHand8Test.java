...
/**
 * Tests that verify whether the PairHand8 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHand8Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHand8.getInstance();
		GameState twoState = PairHand8.getInstance();
