...
/**
 * Tests that verify whether the SoftHandA4orA5 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class SoftHandA4orA5Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = SoftHandA4orA5.getInstance();
		GameState twoState = SoftHandA4orA5.getInstance();
