...
/**
 * State of the game when the hand contains an A,A pair.
 * @author Riya Nadkarni
 * @version 10-15-2018
 */
public class PairHandA implements GameState {

	/** Holds the single instance of this state. */
	private static PairHandA uniqueInstance;
	 ...
	 */
	public static PairHandA getInstance() {
		
		if (uniqueInstance == null) {
			uniqueInstance = new PairHandA();
		}
