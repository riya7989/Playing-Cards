...
/**
 * Tests that verify whether the SoftHandA7 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class SoftHandA7Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = SoftHandA7.getInstance();
		GameState twoState = SoftHandA7.getInstance();
