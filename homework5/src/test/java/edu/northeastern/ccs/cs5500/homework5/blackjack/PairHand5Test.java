...
/**
 * Tests that verify whether the PairHand5 State works as expected.
 * @author Riya Nadkarni
 * @version 10-29-2018
 */
public class PairHand5Test {

	/** Tests the constructor to check whether multiple instances are created or not. */
	@Test
	public void testConstructor() {
		GameState oneState = PairHand5.getInstance();
		GameState twoState = PairHand5.getInstance();
