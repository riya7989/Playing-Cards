...
/**
 * State of the game when the total value of the hand is 15.
 * @author Riya Nadkarni
 * @version 10-15-2018
 */
public class HandValue15 implements GameState {


	/** Holds the single instance of this state. */
	private static HandValue15 uniqueInstance;
	 ...
	 */
	public static HandValue15 getInstance() {
		
		if (uniqueInstance == null) {
			uniqueInstance = new HandValue15();
		}
