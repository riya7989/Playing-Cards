...
public class PlayingCardsTest {
	...
	public void testGameWithStandardDeck() {
		...
		GameClass newGame = new GameClass("standard", 1, 2, 25);
		newGame.deal();
	...
	public void testGameWithStandardDeckAgain() {
		...
		GameClass newGame = new GameClass("standard", 3, 6, 25);
		newGame.deal();
	...
	public void testCreateDeck() {
		...
		GameClass newGame = new GameClass("euchre", 2, 2, 20);
		newGame.createDeck("euchre", 2);
	...
	public void testSetNumberOfCardsWithIllegalInput() {
		...
		GameClass newGame = new GameClass("pinochle", 1, 2, 20);
	...
	public void testGameWithEuchreDeck() {
		...
		GameClass newGame = new GameClass("euchre", 1, 3, 8);
		newGame.deal();
	...
	public void testGameWithEuchreDeckAgain() {
		...
		GameClass newGame = new GameClass("euchre", 2, 3, 12);
		newGame.deal();
	...
	public void testGameWithPinochleDeck() {
		...
		GameClass newGame = new GameClass("pinochle", 1, 4, 10);
		newGame.deal();
	...
	public void testGameWithPinochleDeckAgain() {
		...
		GameClass newGame = new GameClass("pinochle", 2, 10, 9);
		newGame.deal();
		assertEquals("Incorrect number of cards dealt", 6, newGame.getGameDeck().getLength());
	...
	public void testGameWithVegasDeck() {
		...
		GameClass newGame = new GameClass("vegas", 1, 3, 5);
		newGame.deal();
	...
	public void testGameWithVegasDeckAgain() {
		...
		GameClass newGame = new GameClass("vegas", 4, 5, 10);
		newGame.deal();
	...
	/**
	 * Test game with invalid deck type.
	 */
	@Test
	public void testGameWithInvalidDeckType() {

		String expected = "casino is not a valid deck type.";

		try {
			new GameClass("casino", 1, 3, 5);
			fail("Game constructor did not throw an exception when it should have.");
		} catch (IllegalArgumentException ex) {
			assertEquals("Game constructor not working as expected.", expected, ex.getMessage());
		}
	}

	/**
	 * Test game with invalid deck type again.
	 */
	@Test
	public void testGameWithInvalidDeckTypeAgain() {

		String expected = "uno is not a valid deck type.";

		try {
			new GameClass("uno", 2, 3, 5);
			fail("Game constructor did not throw an exception when it should have.");
		} catch (IllegalArgumentException ex) {
			assertEquals("Game constructor not working as expected.", expected, ex.getMessage());
		}
	...
	public void testGameEquals() {
		...
		GameClass poker = new GameClass("vegas", 1, 3, 5);
		GameClass uno = new GameClass("standard", 1, 3, 5);
	...
	public void testGameEqualsAgain() {
		...
		GameClass poker = new GameClass("vegas", 1, 3, 5);
		GameClass uno = new GameClass("vegas", 1, 3, 5);
	...
	public void testShowCardsInHand() {
		...
		GameClass newGame = new GameClass("standard", 1, 2, 3);
		newGame.deal();
	...
	/**
	 * Test shuffle in hand.
	 * Testing it by comparing it to another hand with known order of cards 
	 * and making sure that the number of cards in a different position are more than 
	 * the number of Cards in the same position
	 * Note - May fail at times if the shuffle method ends up changing the position of less than half number of cards.
	 * Note - Works 99% of the times.
	 */
	@Test
	public void testShuffleInHand() {
		...
		GameClass newGame = new GameClass("standard", 1, 1, 6);
		newGame.deal();
		List<Hand> hand = newGame.getGameHand();
	...
	public void testSortByRankInHand() {
		...
		GameClass newGame = new GameClass("standard", 1, 1, 14);
		newGame.deal();
		List<Hand> hand = newGame.getGameHand();
	...
	public void testSortInHandWithIllegalValue() {
		...
		GameClass newGame = new GameClass("standard", 1, 1, 25);
		newGame.deal();
		List<Hand> hand = newGame.getGameHand();
